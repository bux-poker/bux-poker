...
export class TournamentEngine {
  ...
  async _doConsolidateTables(tournamentId) {
    ...
    // Do NOT transfer game.pot into players here - when hands have finished the pot was already
    // awarded and winner's chips updated; transferring again doubles chips in play.
